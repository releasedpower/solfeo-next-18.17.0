        ...
        <div className="mx-auto flex max-w-screen-lg">
          <div className="sticky top-0 hidden max-h-screen p-8 md:block">
            <section className="mx-auto flex flex-col">
              <h2 className="text-3xl">Momba anay</h2>
              <Sizer height={32} />
              <ul className="flex flex-col gap-5 whitespace-nowrap text-xl">
                <li>
                  <SidebarLink>Inona?</SidebarLink>
                </li>
                <li>
                  <SidebarLink>Manomboka</SidebarLink>
                </li>
                <li>
                  <SidebarLink>Misafidy mozika</SidebarLink>
                </li>
                <li>
                  <SidebarLink>Browser compatibility</SidebarLink>
                </li>
                <li>
                  <SidebarLink>Drafitra</SidebarLink>
                </li>
                <li>
...
function WhatSection() {
  return (
    <Article
      header="What"
      first="Solfeo dia fianarana mamaky solfezy sy mitendry piano."
    >
      <p>
        Solfeo dia mety hoan'ireo olona vao manomboka mihitsy – tonga dia ahafahanao mitendry avy hatrany.
      ...
      <Sizer height={24} />
      <p>
        Ho an'ireo izay tia hianatra mozika{' '}
...
function MusicSelectionSection() {
  return (
    <Article
      header="Fisafidianana mozika"
      first="The Solfeo catalog has three components: midishare, builtin, and local file uploads."
    >
      <p>
        Solfeo includes works from <AboutLink href="https://midishare.dev">midishare</AboutLink>,
      ...
      <p>
        ...
        bet. Or you can send me an <AboutLink href="mailto:solfeo@gmail.com">email</AboutLink>{' '}
...
function BrowserCompatibilitySection() {
  return (
    <Article
      ...
      first="Solfeo is fully compatible with the latest versions of Chrome and Firefox."
    >
      <p>
