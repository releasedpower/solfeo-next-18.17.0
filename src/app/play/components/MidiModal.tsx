  ...
  return (
    <Modal show={isOpen} onClose={onClose}>
      <div className="relative flex w-[min(100vw,500px)] flex-col p-8 text-base">
        <h1 className="text-3xl font-bold">Atsatoy ny "Piano"</h1>
        <Sizer height={32} />
        <div className="flex gap-3">
          <h1 className="text-lg font-medium">Fitaovana mampiditra MIDI</h1>
          <button
        ...
        <div className="flex min-h-[200px] flex-col gap-1 rounded-md bg-gray-100">
          {!inputs?.size && (
            <span className="p-5 text-gray-900">
              Tsy mahita fitaovana. Azafady atsatoy ny fitaovana MIDI ary tsindrio ny "havaozina".
            </span>
          )}
          {inputs &&
        ...
        <Sizer height={32} />
        <div className="flex gap-3">
          <h1 className="text-lg font-medium">Fitaovana mandray izay mivoaka</h1>
          <button
            style={{ animationIterationCount: 0.5 }}
