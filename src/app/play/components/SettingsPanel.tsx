...
export default function SettingsPanel(props: SidebarProps) {
  ...
  return (
    <div
      ...
      ref={sidebarRef}
    >
      <h3 className="text-center text-2xl text-purple-primary">Fanamboarana</h3>
        ...
        <Section title="Visualization" className="flex-grow">
          ...
          >
            <input
              ...
              readOnly
            />
            <span className="block w-[120px] text-left">Naoty milatsaka</span>
          </button>
          <button
            className="flex items-center justify-center gap-1"
          ...
          >
            ...
            <span className="block w-[120px] text-left"> Sheet hero</span>
          </button>
        </Section>
        <div className="flex flex-grow flex-col gap-4 sm:flex-row">
          <Section title="Additional settings" className="flex-grow justify-center">
            <div className="flex justify-center">
              <span className="min-w-[15ch]">Miandry</span>
              <Toggle className="" checked={waiting} onChange={handleWaiting} />
            </div>
            <div className="flex justify-center">
              <span className="min-w-[15ch]">Aseho ny anarana naoty</span>
              <Toggle checked={noteLetter} onChange={handleNotes} />
            </div>
            <div className="flex justify-center">
              <span className="min-w-[15ch]">Naoty miloko</span>
              <Toggle checked={coloredNotes} onChange={handleColoredNotes} />
            </div>
            <div className="flex justify-center">
              <span className="min-w-[15ch]">Fanalahidy</span>
              <select
                name="keySignature"
