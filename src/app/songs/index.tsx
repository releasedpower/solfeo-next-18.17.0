    ...
    <>
      ...
      <div className="flex h-screen w-full flex-col bg-purple-lightest">
        ...
        <div className="mx-auto flex w-full max-w-screen-lg flex-grow flex-col p-6">
          <h2 className="text-3xl">Mianatra hira</h2>
          <Sizer height={8} />
          <h3 className="text-base"> Misafidiana hira, amboary ny kipitsony ary hianaro</h3>
          <Sizer height={24} />
